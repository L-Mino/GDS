!function(a) {
    "use strict";
    var e, t, n = localStorage.getItem("language"), s = "en";
    function o(t) {
        document.getElementById("header-lang-img") && ("en" == t ? document.getElementById("header-lang-img").src = "/gds_simple/assets/images/flags/us.jpg" : "sp" == t ? document.getElementById("header-lang-img").src = "/gds_simple/assets/images/flags/spain.jpg" : "gr" == t ? document.getElementById("header-lang-img").src = "/gds_simple/assets/images/flags/germany.jpg" : "it" == t ? document.getElementById("header-lang-img").src = "/gds_simple/assets/images/flags/italy.jpg" : "ru" == t && (document.getElementById("header-lang-img").src = "/gds_simple/assets/images/flags/russia.jpg"),
        localStorage.setItem("language", t),
        "null" == (n = localStorage.getItem("language")) && o(s),
        a.getJSON("/gds_simple/assets/lang/" + n + ".json", function(t) {
            a("html").attr("lang", n),
    ...
    a("#vertical-menu-btn").on("click", function(t) {
        ...
        0 <= a(window).width() && (null == e ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == e ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm"))
    }),
    ...
    function() {
        ...
        t.hasAttribute("data-layout") && "horizontal" == t.getAttribute("data-layout") ? (l("layout-horizontal"),
        ...
        a("input[name='layout-mode']").on("change", function() {
            ...
            t.hasAttribute("data-layout") && "horizontal" == t.getAttribute("data-layout") || (document.body.setAttribute("data-sidebar", "dark"),
            l("sidebar-color-dark"))) : (document.body.setAttribute("data-layout-mode", "dark"),
        ...
        a("input[name='layout-direction']").on("change", function() {
            ...
            document.getElementById("bootstrap-style").setAttribute("href", "/gds_simple/assets/css/bootstrap.min.css"),
            document.getElementById("app-style").setAttribute("href", "/gds_simple/assets/css/app.min.css")) : (document.getElementById("bootstrap-style").setAttribute("href", "/gds_simple/assets/css/bootstrap-rtl.min.css"),
            document.getElementById("app-style").setAttribute("href", "/gds_simple/assets/css/app-rtl.min.css"),
