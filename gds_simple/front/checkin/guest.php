<?php include "../../partials/main.php"; ?>
    ...
    <head>
		<?php $title = '내장객 현황'; include "../../partials/title-meta.php"; ?>
											...
											<div class="col">
												<div class="d-flex flex-wrap align-items-center gap-2 mb-3">
													<div class="form-check form-check-inline ps-0 me-0">
														<select class="form-select form-select-lg border-0 py-0 h-100">
												...
												<table class="table table-fixed text-center">
														...
														<tr>
															...
															<th>할인 코드
																<div class="dropdown d-inline-block">
																	<button class="btn boarder-0 p-0 dropdown-toggle" type="button" id="" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-chevron-down lh-1"></i></button>
																	<ul class="dropdown-menu dropdown-menu-dark">
																		<li><button type="button" class="dropdown-item">test01</button></li>
																		<li><button type="button" class="dropdown-item">test02</button></li>
																	</ul>
																</div>
															</th>
															<th>할인 금액</th>
													...
													<tbody>
														<tr class="table-stripe" onclick="$(this).toggleClass('table-active');">
															<td><input class="form-check-input text-dark" type="checkbox"></td>
															<td>1</td>
															<td>2023.05.18 (일)</td>
															<td>12:11</td>
															<td>하늘 인</td>
