									...
									<table class="table table-layout-fixed mb-0">
										...
										<tbody>
											<tr>
												...
												<td>
													<input class="form-control" type="text" placeholder="국문">
												</td>
													...
													<div class="row w-100">
														<div class="col-9">
															<select class="form-select">
																...
																<option value="프로5" selected>프로5</option>
																<option value="주니어7">주니어7</option>
																<option value="직원8">직원8</option>
															</select>
														</div>
														<div class="col-3 p-0 text-end">
															<span class="d-inline-block align-text-top pt-1">50,000</span>
														</div>
													</div>
												</td>
												<th>할인코드3</th>
													...
													<div class="row w-100">
														<div class="col-9">
															<select class="form-select">
																...
																<option value="프로5">프로5</option>
																<option value="주니어7">주니어7</option>
																<option value="직원8" selected>직원8</option>
															</select>
														</div>
														<div class="col-3 p-0 text-end">
															<span class="d-inline-block align-text-top pt-1">80,000</span>
														</div>
													</div>
												</td>
											</tr>
